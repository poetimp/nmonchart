...
#------------------------------------------------------------------------------------------
#
# Program: nmonchart.pl
# Author:  Paul Lemmons
# Date:    09/05/2017
# Description:
#          This program will read a file generated by nmon, running in batch mode and
#          generate a web page that will displays graphs of that data. Based extensively
#          on the work done by Nigel Griffiths.
#------------------------------------------------------------------------------------------
